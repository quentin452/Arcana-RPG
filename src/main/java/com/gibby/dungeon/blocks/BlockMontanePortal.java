...
public class BlockMontanePortal extends Block
{
    ...
    public void randomDisplayTick(final World p_149734_1_, final int p_149734_2_, final int p_149734_3_, final int p_149734_4_, final Random p_149734_5_) {
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            p_149734_1_.spawnParticle("instaSpell", d0, d2, d3, d4, d5, d6);
        }
        for (int j = 0; j < 10; ++j) {
    ...
    public void onNeighborBlockChange(final World par1World, final int par2, final int par3, final int par4, final Block par5) {
        ...
        if (par1World.getBlock(par2, i1 - 1, par4) != Dungeons.stoneDoor) {
            par1World.setBlockToAir(par2, par3, par4);
        }
        else {
            int j1;
            for (j1 = 1; j1 < 4 && par1World.getBlock(par2, i1 + j1, par4) == this; ++j1) {}
            if (j1 == 3 && par1World.getBlock(par2, i1 + j1, par4) == Dungeons.stoneDoor) {
                ...
                else if ((par1World.getBlock(par2 + b0, par3, par4 + b2) != Dungeons.stoneDoor || par1World.getBlock(par2 - b0, par3, par4 - b2) != this) && (par1World.getBlock(par2 - b0, par3, par4 - b2) != Dungeons.stoneDoor || par1World.getBlock(par2 + b0, par3, par4 + b2) != this)) {
                    par1World.setBlockToAir(par2, par3, par4);
                }
            }
        }
