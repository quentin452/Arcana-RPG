...
public class BlockCrystalPlainsPortal extends Block
{
    ...
    public void onNeighborBlockChange(final World par1World, final int par2, final int par3, final int par4, final Block par5) {
        ...
        if (par1World.getBlock(par2, i1 - 1, par4) != Dungeons.purpleBrick) {
            par1World.setBlockToAir(par2, par3, par4);
        }
        else {
            int j1;
            for (j1 = 1; j1 < 4 && par1World.getBlock(par2, i1 + j1, par4) == this; ++j1) {}
            if (j1 == 3 && par1World.getBlock(par2, i1 + j1, par4) == Dungeons.purpleBrick) {
                ...
                else if ((par1World.getBlock(par2 + b0, par3, par4 + b2) != Dungeons.purpleBrick || par1World.getBlock(par2 - b0, par3, par4 - b2) != this) && (par1World.getBlock(par2 - b0, par3, par4 - b2) != Dungeons.purpleBrick || par1World.getBlock(par2 + b0, par3, par4 + b2) != this)) {
                    par1World.setBlockToAir(par2, par3, par4);
                }
            }
        }
