    ...
    public void onEntityCollidedWithBlock(final World par1World, final int par2, final int par3, final int par4, final Entity par5Entity) {
        if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null && par5Entity instanceof EntityPlayerMP) {
            ...
            if (player.timeUntilPortal > 0) {
                ...
                player.timeUntilPortal = 3;
                player.mcServer.getConfigurationManager().transferPlayerToDimension(player, Dungeons.sunsetDimensionId, (Teleporter)new TeleporterSunset(mServer.worldServerForDimension(Dungeons.sunsetDimensionId)));
            }
            else {
                player.timeUntilPortal = 3;
                player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, (Teleporter)new TeleporterSunset(mServer.worldServerForDimension(0)));
