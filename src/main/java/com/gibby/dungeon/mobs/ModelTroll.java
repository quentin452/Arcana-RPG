...
public class ModelTroll extends ModelBase
{
    ...
    public ModelTroll() {
        ...
        (this.mane = new ModelRenderer((ModelBase)this, 0, 38)).addBox(-7.0f, -12.0f, 0.0f, 14, 14, 0);
        ...
        (this.head = new ModelRenderer((ModelBase)this, 0, -1)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        this.head.setRotationPoint(0.0f, 1.0f, -10.0f);
        this.head.setTextureSize(128, 128);
        this.head.mirror = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        (this.body = new ModelRenderer((ModelBase)this, 16, 16)).addBox(-6.0f, 0.0f, -3.0f, 12, 16, 6);
        this.body.setRotationPoint(0.0f, 0.0f, -9.0f);
        this.body.setTextureSize(128, 128);
        this.body.mirror = true;
        this.setRotation(this.body, 0.6108652f, 0.0f, 0.0f);
        (this.rightarm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-4.0f, -2.0f, -2.0f, 4, 24, 4);
        this.rightarm.setRotationPoint(-6.0f, 2.0f, -9.0f);
        this.rightarm.setTextureSize(128, 128);
        this.rightarm.mirror = true;
        this.setRotation(this.rightarm, 0.0f, 0.0f, 0.0f);
        (this.leftarm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(0.0f, -2.0f, -2.0f, 4, 24, 4);
