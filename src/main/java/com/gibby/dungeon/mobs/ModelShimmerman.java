...
public class ModelShimmerman extends ModelBase
{
    ...
    public ModelShimmerman() {
        ...
        (this.Shape1 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, -10.0f, -22.0f, 2, 18, 2);
        this.Shape1.setRotationPoint(6.0f, -14.0f, -1.0f);
        this.Shape1.setTextureSize(64, 32);
        this.Shape1.mirror = true;
        this.setRotation(this.Shape1, 1.570796f, 3.141593f, 0.0f);
        (this.Shape2 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, -13.0f, 20.0f, 1, 4, 1);
        this.Shape2.setRotationPoint(5.5f, -13.5f, 0.0f);
        this.Shape2.setTextureSize(64, 32);
        this.Shape2.mirror = true;
        this.setRotation(this.Shape2, 1.570796f, 0.0f, 3.141593f);
        (this.Shape3 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, -16.0f, 21.0f, 1, 5, 1);
        ...
        (this.o = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 1);
