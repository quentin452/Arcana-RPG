...
public class ModelCrystox extends ModelBase
{
    ...
    public ModelCrystox() {
        ...
        (this.Leaf1 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -8.0f, -1.0f, 6, 8, 1);
        this.Leaf1.setRotationPoint(0.0f, 24.0f, -3.0f);
        this.Leaf1.setTextureSize(64, 32);
        this.Leaf1.mirror = true;
        this.setRotation(this.Leaf1, 1.047198f, 0.0f, 0.0f);
        (this.Leaf2 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(0.0f, -8.0f, -3.0f, 1, 8, 6);
        this.Leaf2.setRotationPoint(3.0f, 24.0f, 0.0f);
        this.Leaf2.setTextureSize(64, 32);
        this.Leaf2.mirror = true;
        this.setRotation(this.Leaf2, 0.0f, 0.0f, 1.047198f);
        (this.Leaf3 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-1.0f, -8.0f, -3.0f, 1, 8, 6);
        this.Leaf3.setRotationPoint(-3.0f, 24.0f, 0.0f);
        this.Leaf3.setTextureSize(64, 32);
        this.Leaf3.mirror = true;
        this.setRotation(this.Leaf3, 0.0f, 0.0f, -1.047198f);
        (this.Leaf4 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -8.0f, 0.0f, 6, 8, 1);
        this.Leaf4.setRotationPoint(0.0f, 24.0f, 3.0f);
        this.Leaf4.setTextureSize(64, 32);
        this.Leaf4.mirror = true;
        this.setRotation(this.Leaf4, -1.047198f, 0.0f, 0.0f);
        (this.Stem = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-1.0f, 0.0f, -1.0f, 2, 16, 2);
        ...
        (this.Head = new ModelRenderer((ModelBase)this, "Head")).setRotationPoint(0.0f, 8.0f, 0.0f);
