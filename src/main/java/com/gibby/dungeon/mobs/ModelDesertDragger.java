...
public class ModelDesertDragger extends ModelBase
{
    ...
    public ModelDesertDragger() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 0, 47)).addBox(-3.0f, -1.0f, -7.0f, 6, 2, 12);
        this.Body.setRotationPoint(0.0f, 12.0f, 3.0f);
        this.Body.setTextureSize(64, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, -0.4363323f, 0.0f, 0.0f);
        (this.TailSeg3 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-2.0f, -1.0f, -2.0f, 4, 2, 6);
        ...
        (this.TailSeg1 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, -3.0f, -2.0f, 8, 6, 4);
        ...
        (this.TailSeg2 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -2.0f, -2.0f, 6, 4, 4);
        ...
        (this.Shell = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-5.0f, -4.0f, -8.0f, 10, 8, 16);
        ...
        (this.RightLeg = new ModelRenderer((ModelBase)this, 36, 27)).addBox(-2.0f, -1.0f, -2.0f, 4, 14, 4);
        this.RightLeg.setRotationPoint(7.0f, 11.0f, -6.0f);
        this.RightLeg.setTextureSize(64, 64);
        this.RightLeg.mirror = true;
        this.setRotation(this.RightLeg, 0.0f, 0.0f, 0.0f);
        (this.LeftLeg = new ModelRenderer((ModelBase)this, 36, 27)).addBox(-2.0f, -1.0f, -2.0f, 4, 14, 4);
        this.LeftLeg.setRotationPoint(-7.0f, 11.0f, -6.0f);
        this.LeftLeg.setTextureSize(64, 64);
        this.LeftLeg.mirror = true;
        this.setRotation(this.LeftLeg, 0.0f, 0.0f, 0.0f);
        (this.Head = new ModelRenderer((ModelBase)this, 0, 29)).addBox(-4.0f, -7.0f, -6.0f, 8, 8, 8);
