...
public class ModelMoltroll extends ModelBase
{
    ...
    public ModelMoltroll() {
        ...
        (this.head = new ModelRenderer(this, 0, 50)).addBox(-5.0f, -8.0f, -5.0f, 10, 10, 10);
        this.head.setRotationPoint(0.0f, -11.0f, -20.0f);
        this.head.setTextureSize(128, 128);
        this.head.mirror = true;
        this.setRotation(this.head, 0.0f);
        (this.body2 = new ModelRenderer(this, 0, 80)).addBox(-7.0f, -5.0f, -12.0f, 16, 6, 14);
        this.body2.setRotationPoint(-1.0f, -8.0f, -8.0f);
        this.body2.setTextureSize(128, 128);
        this.body2.mirror = true;
        this.setRotation(this.body2, 0.0f);
        (this.rightarm2 = new ModelRenderer(this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 4, 35, 4);
        this.rightarm2.setRotationPoint(-8.0f, -9.0f, -12.0f);
        this.rightarm2.setTextureSize(128, 128);
        this.rightarm2.mirror = true;
        this.setRotation(this.rightarm2, 0.0f);
        (this.leftarm2 = new ModelRenderer(this, 40, 16)).addBox(-1.0f, -2.0f, -2.0f, 4, 35, 4);
        this.leftarm2.setRotationPoint(8.0f, -9.0f, -12.0f);
        this.leftarm2.setTextureSize(128, 128);
        this.leftarm2.mirror = true;
        this.setRotation(this.leftarm2, 0.0f);
        ...
        (this.body = new ModelRenderer(this, 70, 30)).addBox(-6.0f, 0.0f, -2.0f, 12, 16, 6);
        this.body.setRotationPoint(0.0f, 0.0f, 3.0f);
        this.body.setTextureSize(128, 128);
        this.body.mirror = true;
        this.setRotation(this.body, 0.5235988f);
        (this.body3 = new ModelRenderer(this, 70, 0)).addBox(-7.0f, -15.0f, -2.0f, 14, 17, 6);
        this.body3.setRotationPoint(0.0f, 0.0f, 3.0f);
        this.body3.setTextureSize(128, 128);
        this.body3.mirror = true;
        this.setRotation(this.body3, 0.9424778f);
        (this.rightarm = new ModelRenderer(this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 4, 29, 4);
        ...
        (this.leftarm = new ModelRenderer(this, 40, 16)).addBox(-1.0f, -2.0f, -2.0f, 4, 29, 4);
    ...
    public void setRotationAngles(final float f, final float f1, final float f2, final float f3, final float f4, final float f5, final Entity entity) {
        ...
        this.leftleg.rotateAngleX = -1.5f * this.func_78172_a(f) * f1;
        this.rightleg.rotateAngleX = 1.5f * this.func_78172_a(f) * f1;
