...
public class ModelOrc extends ModelBase
{
    ...
    public ModelOrc() {
        ...
        this.setTextureOffset("leftArm.Sword3", 0, 44);
        this.setTextureOffset("leftArm.Sword1", 0, 44);
        this.setTextureOffset("leftArm.Sword2", 0, 44);
        this.setTextureOffset("leftArm.Sword4", 0, 44);
        this.setTextureOffset("leftArm.Sword5", 0, 44);
        this.setTextureOffset("leftArm.Sword6", 0, 44);
        ...
        this.leftArm.addBox("Sword3", 2.0f, 7.0f, -33.0f, 1, 2, 2);
        this.leftArm.addBox("Sword1", 2.0f, 9.0f, -10.0f, 1, 2, 8);
        this.leftArm.addBox("Sword2", 2.0f, 8.0f, -24.0f, 1, 3, 14);
        this.leftArm.addBox("Sword4", 2.0f, 5.0f, -36.0f, 1, 1, 9);
        this.leftArm.addBox("Sword5", 2.0f, 7.0f, -31.0f, 1, 3, 14);
        this.leftArm.addBox("Sword6", 2.0f, 6.0f, -35.0f, 1, 1, 14);
