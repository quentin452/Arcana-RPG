...
public class ModelVoidLord extends ModelBase
{
    ...
    public ModelVoidLord() {
        ...
        (this.Backspike1 = new ModelRenderer(this, 0, 0)).addBox(0.0f, -12.0f, 3.0f, 1, 19, 2);
        ...
        (this.rod1 = new ModelRenderer(this, 0, 0)).addBox(-1.0f, 19.0f, -19.0f, 2, 2, 23);
        ...
        (this.rod2 = new ModelRenderer(this, 0, 0)).addBox(-1.0f, -23.0f, 19.0f, 1, 4, 1);
        ...
        (this.rod3 = new ModelRenderer(this, 0, 0)).addBox(0.0f, -24.0f, 21.0f, 1, 5, 1);
        ...
        (this.BackSpike2 = new ModelRenderer(this, 0, 0)).addBox(0.0f, -12.0f, -1.0f, 1, 18, 2);
        this.BackSpike2.setRotationPoint(-5.0f, -17.0f, 5.0f);
        this.BackSpike2.setTextureSize(64, 32);
        this.BackSpike2.mirror = true;
        this.setRotation(this.BackSpike2, 0.0f, -90.0f, 45.0f);
        (this.BackSpike3 = new ModelRenderer(this, 0, 0)).addBox(0.0f, -12.0f, 3.0f, 1, 18, 2);
        this.BackSpike3.setRotationPoint(6.0f, -17.0f, 6.0f);
        this.BackSpike3.setTextureSize(64, 32);
        this.BackSpike3.mirror = true;
        this.setRotation(this.BackSpike3, 0.0f, -90.0f, 45.0f);
        (this.BackSpike4 = new ModelRenderer(this, 0, 0)).addBox(0.0f, -12.0f, 0.0f, 1, 17, 2);
