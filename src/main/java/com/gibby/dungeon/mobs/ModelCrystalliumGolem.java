...
public class ModelCrystalliumGolem extends ModelBase
{
    ...
    public ModelCrystalliumGolem() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-10.0f, -7.0f, -7.0f, 20, 14, 14);
        this.Body.setRotationPoint(0.0f, -4.0f, 0.0f);
        this.Body.setTextureSize(128, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.7853982f, 0.0f, 0.0f);
        (this.Pelvis = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, 0.0f, -4.0f, 8, 14, 8);
        ...
        (this.Leftleg = new ModelRenderer((ModelBase)this, 70, 0)).addBox(-4.0f, -2.0f, -2.0f, 4, 12, 4);
        this.Leftleg.setRotationPoint(-4.0f, 14.0f, 0.0f);
        this.Leftleg.setTextureSize(128, 64);
        this.Leftleg.mirror = true;
        this.setRotation(this.Leftleg, 0.0f, 0.0f, 0.0f);
        (this.Rightleg = new ModelRenderer((ModelBase)this, 70, 0)).addBox(0.0f, -2.0f, -2.0f, 4, 12, 4);
        this.Rightleg.setRotationPoint(4.0f, 14.0f, 0.0f);
        this.Rightleg.setTextureSize(128, 64);
        this.Rightleg.mirror = true;
        this.setRotation(this.Rightleg, 0.0f, 0.0f, 0.0f);
        (this.LeftArm = new ModelRenderer((ModelBase)this, "LeftArm")).setRotationPoint(-10.0f, -6.0f, 0.0f);
        ...
        (this.RightArm = new ModelRenderer((ModelBase)this, "RightArm")).setRotationPoint(10.0f, -6.0f, 0.0f);
        ...
        (this.Head = new ModelRenderer((ModelBase)this, "Head")).setRotationPoint(0.0f, -6.0f, -8.0f);
