...
public class EntityRagedProjectile extends EntityThrowable
{
    public EntityRagedProjectile(final World par1World) {
        super(par1World);
    }

    public EntityRagedProjectile(final World par1World, final EntityLivingBase par2EntityLivingBase) {
        super(par1World, par2EntityLivingBase);
    }

    public EntityRagedProjectile(final World par1World, final double par2, final double par4, final double par6) {
    ...
    protected void onImpact(final MovingObjectPosition var1) {
        if (var1.entityHit instanceof EntityLivingBase && !(var1.entityHit instanceof EntityMidnightTitan)) {
