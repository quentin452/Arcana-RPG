...
public class EntityRuneEffect extends EntityThrowable
{
    boolean impacted;
    int counter;
    double freezeX;
    ...
    public EntityRuneEffect(final World par1World) {
        super(par1World);
        this.impacted = false;
        this.counter = 0;
        this.freezeX = 0.0;
    ...
    public EntityRuneEffect(final World par1World, final EntityLivingBase par2EntityLivingBase) {
    ...
    public EntityRuneEffect(final World par1World, final double par2, final double par4, final double par6) {
