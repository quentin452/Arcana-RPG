...
public class ModelIceShielder extends ModelBase
{
    ...
    public ModelIceShielder() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-8.0f, -8.0f, -8.0f, 16, 16, 16);
        this.Body.setRotationPoint(0.0f, 0.0f, 7.0f);
        this.Body.setTextureSize(64, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.0f, 0.0f, 0.0f);
        (this.FrontShield1 = new ModelRenderer((ModelBase)this, 0, 42)).addBox(-4.0f, -17.0f, -1.0f, 8, 20, 2);
        ...
        (this.FrontShield2 = new ModelRenderer((ModelBase)this, 0, 42)).addBox(-4.0f, -2.0f, -1.0f, 8, 20, 2);
        ...
        (this.SideShield1 = new ModelRenderer((ModelBase)this, 0, 38)).addBox(-1.0f, -3.0f, -7.0f, 2, 6, 20);
        ...
        (this.SideShield2 = new ModelRenderer((ModelBase)this, 0, 38)).addBox(0.0f, -3.0f, -7.0f, 2, 6, 20);
        ...
        (this.Tail3 = new ModelRenderer((ModelBase)this, 0, 50)).addBox(-4.0f, -4.0f, -1.0f, 8, 8, 2);
        this.Tail3.setRotationPoint(0.0f, 0.0f, 20.0f);
        this.Tail3.setTextureSize(64, 64);
        this.Tail3.mirror = true;
        this.setRotation(this.Tail3, 0.0f, 0.0f, 0.0f);
        (this.Tail1 = new ModelRenderer((ModelBase)this, 0, 50)).addBox(-6.0f, -6.0f, -1.0f, 12, 12, 2);
        this.Tail1.setRotationPoint(0.0f, 0.0f, 16.0f);
        this.Tail1.setTextureSize(64, 64);
        this.Tail1.mirror = true;
        this.setRotation(this.Tail1, 0.0f, 0.0f, 0.0f);
        (this.Tail2 = new ModelRenderer((ModelBase)this, 0, 50)).addBox(-5.0f, -5.0f, -1.0f, 10, 10, 2);
        this.Tail2.setRotationPoint(0.0f, 0.0f, 18.0f);
        this.Tail2.setTextureSize(64, 64);
        this.Tail2.mirror = true;
        this.setRotation(this.Tail2, 0.0f, 0.0f, 0.0f);
        (this.Bottom = new ModelRenderer((ModelBase)this, 18, 17)).addBox(-6.0f, -1.0f, -6.0f, 12, 2, 12);
        ...
        (this.Top = new ModelRenderer((ModelBase)this, 18, 17)).addBox(-6.0f, -1.0f, -6.0f, 12, 2, 12);
