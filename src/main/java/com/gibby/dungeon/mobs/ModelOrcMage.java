...
public class ModelOrcMage extends ModelBase
{
    ModelRenderer belly;
    ...
    public ModelOrcMage() {
        ...
        this.leftArm.addBox("Gem", 1.0f, 10.0f, -30.0f, 2, 2, 2);
        this.leftArm.addBox("Wand2", 1.0f, 10.0f, -26.0f, 2, 2, 24);
        this.leftArm.addBox("Wand3", 0.0f, 9.0f, -12.0f, 4, 4, 2);
        this.leftArm.addBox("Wand4", 0.0f, 9.0f, -20.0f, 4, 4, 2);
        this.leftArm.addBox("Wand5", 0.0f, 9.0f, -28.0f, 4, 4, 2);
