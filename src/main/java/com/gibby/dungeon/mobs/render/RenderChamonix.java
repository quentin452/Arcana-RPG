...
import com.gibby.dungeon.mobs.model.ModelChamonix;
...
public class RenderChamonix implements IItemRenderer
{
    private static final ResourceLocation swordTextures;
    ModelChamonix swordmodel;

    public RenderChamonix() {
        this.swordmodel = new ModelChamonix();
    }
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        switch (type) {
            case EQUIPPED: {
                GL11.glPushMatrix();
                Minecraft.getMinecraft().renderEngine.bindTexture(RenderChamonix.swordTextures);
    ...
    static {
        swordTextures = new ResourceLocation("gibby_dungeons:textures/items/chamonix.png");
    }
}
