...
public class RenderShadowAxe implements IItemRenderer
{
    private static final ResourceLocation swordTextures;
    ModelSunAxe swordmodel;

    public RenderShadowAxe() {
    ...
    public void renderItem(final IItemRenderer.ItemRenderType type, final ItemStack item, final Object... data) {
        switch (type) {
            case EQUIPPED: {
                ...
                GL11.glPushMatrix();
                Minecraft.getMinecraft().renderEngine.bindTexture(RenderShadowAxe.swordTextures);
    ...
    static {
        swordTextures = new ResourceLocation("gibby_dungeons:textures/items/nightaxe.png");
    }
}
