...
public class EntityTornado extends EntityMob
{
    ...
    public EntityTornado(final World par1World) {
        super(par1World);
    ...
    protected Item getDropItem() {
        return Dungeons.stormRod;
    }
    
    protected void dropFewItems(final boolean par1, final int par2) {
        this.dropItem(Dungeons.stormRod, 1);
    }
        ...
        if (this.attackTime <= 0 && par2 < 2.0f && par1Entity.boundingBox.maxY > this.boundingBox.minY && par1Entity.boundingBox.minY < this.boundingBox.maxY) {
            ...
            if (this.attackTime == 0) {
                ...
                if (this.field_70846_g > 1) {
                    ...
                    for (int i = 0; i < 3; ++i) {
                        final EntityTornadoBall entitysmallfireball = new EntityTornadoBall(this.worldObj, (EntityLivingBase)this);
    ...
    public void onLivingUpdate() {
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            this.worldObj.spawnParticle("largesmoke", this.posX + (this.rand.nextDouble() - 0.5) * this.width, this.posY + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5) * this.width, this.rand.nextGaussian() / 100.0, this.rand.nextGaussian() / 100.0, this.rand.nextGaussian() / 100.0);
        }
    }
}
