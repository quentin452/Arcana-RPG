...
public class ModelUndefeatable extends ModelBase
{
    ...
    public ModelUndefeatable() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-5.0f, -8.0f, -4.0f, 10, 16, 8);
        this.Body.setRotationPoint(0.0f, 3.0f, 0.0f);
        this.Body.setTextureSize(64, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.0f, 0.0f, 0.0f);
        (this.BodyPlate1 = new ModelRenderer((ModelBase)this, 42, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 1);
        ...
        (this.BodyPlate2 = new ModelRenderer((ModelBase)this, 42, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 1);
        ...
        (this.BodyPlate3 = new ModelRenderer((ModelBase)this, 42, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 1);
        ...
        (this.BodyPlate4 = new ModelRenderer((ModelBase)this, 42, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 1);
        ...
        (this.BodyPlate5 = new ModelRenderer((ModelBase)this, 42, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 1);
        ...
        (this.BodyPlate6 = new ModelRenderer((ModelBase)this, 42, 0)).addBox(0.0f, 0.0f, 0.0f, 2, 12, 1);
        ...
        (this.RightArm = new ModelRenderer((ModelBase)this, "RightArm")).setRotationPoint(5.0f, -2.0f, 0.0f);
        ...
        (this.Head = new ModelRenderer((ModelBase)this, "Head")).setRotationPoint(0.0f, -5.0f, 0.0f);
        ...
        (this.LeftArm = new ModelRenderer((ModelBase)this, "LeftArm")).setRotationPoint(-5.0f, -2.0f, 0.0f);
        ...
        (this.RightLeg = new ModelRenderer((ModelBase)this, "RightLeg")).setRotationPoint(3.0f, 11.0f, 0.0f);
        ...
        (this.LeftLeg = new ModelRenderer((ModelBase)this, "LeftLeg")).setRotationPoint(-3.0f, 11.0f, 0.0f);
