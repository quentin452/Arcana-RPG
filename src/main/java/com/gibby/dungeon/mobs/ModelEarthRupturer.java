...
public class ModelEarthRupturer extends ModelBase
{
    ...
    public ModelEarthRupturer() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, -4.0f, -4.0f, 8, 8, 8);
        this.Body.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body.setTextureSize(64, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.0f, 0.0f, 0.0f);
        (this.RightLeg = new ModelRenderer((ModelBase)this, "RightLeg")).setRotationPoint(4.0f, 0.0f, 0.0f);
        this.setRotation(this.RightLeg, 0.0f, 0.0f, 0.0f);
        this.RightLeg.mirror = true;
        this.RightLeg.addBox("RightLeg1", 0.0f, -2.0f, -2.0f, 6, 4, 4);
        this.RightLeg.addBox("RightLeg2", 6.0f, -6.0f, -2.0f, 4, 30, 4);
        (this.LeftLeg = new ModelRenderer((ModelBase)this, "LeftLeg")).setRotationPoint(-4.0f, 0.0f, 0.0f);
        this.setRotation(this.LeftLeg, 0.0f, 0.0f, 0.0f);
        this.LeftLeg.mirror = true;
        this.LeftLeg.addBox("LeftLeg1", -6.0f, -2.0f, -2.0f, 6, 4, 4);
        this.LeftLeg.addBox("LeftLeg2", -10.0f, -6.0f, -2.0f, 4, 30, 4);
        (this.BackNode = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-2.0f, -2.0f, 0.0f, 4, 4, 10);
        ...
        (this.RightBackLeg = new ModelRenderer((ModelBase)this, 48, 0)).addBox(0.0f, -6.0f, -2.0f, 4, 30, 4);
        ...
        (this.LeftBackLeg = new ModelRenderer((ModelBase)this, 48, 0)).addBox(-4.0f, -6.0f, -2.0f, 4, 30, 4);
        ...
        (this.LeftFrontLeg = new ModelRenderer((ModelBase)this, 48, 0)).addBox(-4.0f, -6.0f, -2.0f, 4, 30, 4);
        ...
        (this.FrontNode = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-2.0f, -2.0f, -10.0f, 4, 4, 10);
        ...
        (this.RightFrontLeg = new ModelRenderer((ModelBase)this, 48, 0)).addBox(0.0f, -6.0f, -2.0f, 4, 30, 4);
        ...
        (this.Head = new ModelRenderer((ModelBase)this, 0, 17)).addBox(-3.0f, -6.0f, -3.0f, 6, 6, 6);
