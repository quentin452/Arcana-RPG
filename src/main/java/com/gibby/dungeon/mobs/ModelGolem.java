...
public class ModelGolem extends ModelBase
{
    ...
    public ModelGolem() {
        ...
        (this.head2 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -4.0f, -5.0f, 6, 10, 10);
        ...
        (this.head3 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, -4.0f, -5.0f, 7, 10, 10);
        ...
        (this.head = new ModelRenderer((ModelBase)this, -1, 64)).addBox(-8.0f, -7.0f, -8.0f, 16, 16, 16);
        this.head.setRotationPoint(0.0f, -9.0f, 0.0f);
        this.head.setTextureSize(128, 128);
        this.head.mirror = true;
        this.setRotation(this.head, 0.7853982f, 0.0f, 0.0f);
        (this.body = new ModelRenderer((ModelBase)this, 16, 11)).addBox(-5.0f, -4.0f, -1.0f, 10, 12, 4);
        this.body.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.body.setTextureSize(128, 128);
        this.body.mirror = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.rightarm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-1.0f, -2.0f, -2.0f, 6, 25, 8);
        this.rightarm.setRotationPoint(-18.0f, -8.0f, -2.0f);
        this.rightarm.setTextureSize(128, 128);
        this.rightarm.mirror = true;
        this.setRotation(this.rightarm, 0.0f, 0.0f, 0.0f);
        (this.leftarm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-1.0f, -2.0f, -2.0f, 6, 25, 8);
        this.leftarm.setRotationPoint(13.0f, -8.0f, -2.0f);
        this.leftarm.setTextureSize(128, 128);
        this.leftarm.mirror = true;
        this.setRotation(this.leftarm, 0.0f, 0.0f, 0.0f);
        (this.rightleg = new ModelRenderer((ModelBase)this, 0, 32)).addBox(-3.0f, 0.0f, -1.0f, 6, 16, 4);
        this.rightleg.setRotationPoint(-4.0f, 8.0f, 0.0f);
        this.rightleg.setTextureSize(128, 128);
        this.rightleg.mirror = true;
        this.setRotation(this.rightleg, 0.0f, 0.0f, 0.0f);
        (this.leftleg = new ModelRenderer((ModelBase)this, 0, 32)).addBox(-3.0f, 0.0f, -1.0f, 6, 16, 4);
