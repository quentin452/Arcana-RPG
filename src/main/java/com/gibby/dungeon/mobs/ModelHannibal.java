...
public class ModelHannibal extends ModelBase
{
    ...
    public ModelHannibal() {
        ...
        (this.Shoulderpad1 = new ModelRenderer((ModelBase)this, 0, 43)).addBox(0.0f, 0.0f, 0.0f, 7, 4, 8);
        ...
        (this.Shoulderpad = new ModelRenderer((ModelBase)this, 0, 43)).addBox(0.0f, 0.0f, 0.0f, 7, 4, 8);
        ...
        (this.head = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, -8.0f, -4.0f, 10, 10, 10);
        this.head.setRotationPoint(-1.0f, -15.0f, -1.0f);
        this.head.setTextureSize(128, 128);
        this.head.mirror = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.0f);
        (this.body = new ModelRenderer((ModelBase)this, 64, 0)).addBox(-7.0f, 0.0f, -3.0f, 16, 20, 10);
        this.body.setRotationPoint(-1.0f, -13.0f, -2.0f);
        this.body.setTextureSize(128, 128);
        this.body.mirror = true;
        this.setRotation(this.body, 0.0f, 0.0f, 0.0f);
        (this.rightarm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 6, 18, 6);
        this.rightarm.setRotationPoint(-11.0f, -10.0f, -1.0f);
        this.rightarm.setTextureSize(128, 128);
        this.rightarm.mirror = true;
        this.setRotation(this.rightarm, 0.0f, 0.0f, 0.0f);
        (this.leftarm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-1.0f, -2.0f, -2.0f, 6, 18, 6);
        this.leftarm.setRotationPoint(9.0f, -10.0f, -1.0f);
        this.leftarm.setTextureSize(128, 128);
        this.leftarm.mirror = true;
        this.setRotation(this.leftarm, 0.0f, 0.0f, 0.0f);
        (this.rightleg = new ModelRenderer((ModelBase)this, 0, 20)).addBox(-2.0f, 0.0f, -2.0f, 6, 16, 6);
        this.rightleg.setRotationPoint(-5.0f, 7.0f, -1.0f);
        this.rightleg.setTextureSize(128, 128);
        this.rightleg.mirror = true;
        this.setRotation(this.rightleg, 0.0f, 0.0f, 0.0f);
        (this.leftleg = new ModelRenderer((ModelBase)this, 0, 20)).addBox(-2.0f, 0.0f, -2.0f, 6, 16, 6);
