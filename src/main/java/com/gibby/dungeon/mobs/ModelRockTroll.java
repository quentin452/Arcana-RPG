...
public class ModelRockTroll extends ModelBase
{
    ...
    public ModelRockTroll() {
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 76, 20)).addBox(-8.0f, -10.0f, -5.0f, 16, 20, 10);
        this.Body.setRotationPoint(0.0f, 3.0f, 7.0f);
        this.Body.setTextureSize(128, 64);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.5576792f, 0.0f, 0.0f);
        (this.RightLeg = new ModelRenderer((ModelBase)this, 0, 0)).addBox(9.0f, -1.0f, -3.0f, 6, 14, 6);
        this.RightLeg.setRotationPoint(-6.0f, 11.0f, 9.0f);
        this.RightLeg.setTextureSize(128, 64);
        this.RightLeg.mirror = true;
        this.setRotation(this.RightLeg, 0.0f, 0.0f, 0.0f);
        (this.LeftLeg = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -1.0f, -3.0f, 6, 14, 6);
        this.LeftLeg.setRotationPoint(-6.0f, 11.0f, 9.0f);
        this.LeftLeg.setTextureSize(128, 64);
        this.LeftLeg.mirror = true;
        this.setRotation(this.LeftLeg, 0.0f, 0.0f, 0.0f);
        (this.LeftArm = new ModelRenderer((ModelBase)this, "LeftArm")).setRotationPoint(-8.0f, -2.0f, 4.0f);
        ...
        (this.RightArm = new ModelRenderer((ModelBase)this, "RightArm")).setRotationPoint(8.0f, -2.0f, 4.0f);
        ...
        (this.Tail = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-1.0f, -3.0f, -1.0f, 2, 6, 2);
        ...
        (this.Tail2 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-2.0f, -3.0f, -2.0f, 4, 6, 4);
        ...
        (this.Head = new ModelRenderer((ModelBase)this, "Head")).setRotationPoint(0.0f, -3.0f, 0.0f);
