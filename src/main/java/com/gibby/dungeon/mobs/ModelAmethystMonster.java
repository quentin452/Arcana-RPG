...
public class ModelAmethystMonster extends ModelBase
{
    ...
    public ModelAmethystMonster() {
        ...
        (this.head = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -7.0f, -21.0f, 6, 6, 16);
        this.head.setRotationPoint(-3.0f, -2.0f, -5.0f);
        this.head.setTextureSize(128, 128);
        this.head.mirror = true;
        this.setRotation(this.head, 0.0f, 0.0f, 0.7853982f);
        (this.body = new ModelRenderer((ModelBase)this, 16, 24)).addBox(-6.0f, 0.0f, -8.0f, 12, 9, 8);
        this.body.setRotationPoint(0.0f, -5.0f, -1.0f);
        this.body.setTextureSize(128, 128);
        this.body.mirror = true;
        this.setRotation(this.body, 0.6981317f, 0.0f, 0.0f);
        (this.rightarm = new ModelRenderer((ModelBase)this, 40, 80)).addBox(-2.0f, 4.0f, 17.0f, 1, 16, 2);
        ...
        (this.leftarm = new ModelRenderer((ModelBase)this, 40, 80)).addBox(1.0f, 4.0f, 17.0f, 1, 16, 2);
        ...
        (this.rightleg = new ModelRenderer((ModelBase)this, 0, 27)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4);
        this.rightleg.setRotationPoint(-3.0f, 12.0f, 6.0f);
        this.rightleg.setTextureSize(128, 128);
        this.rightleg.mirror = true;
        this.setRotation(this.rightleg, 0.0f, 0.0f, 0.0f);
        (this.leftleg = new ModelRenderer((ModelBase)this, 0, 27)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4);
        this.leftleg.setRotationPoint(3.0f, 12.0f, 6.0f);
        this.leftleg.setTextureSize(128, 128);
        this.leftleg.mirror = true;
        this.setRotation(this.leftleg, 0.0f, 0.0f, 0.0f);
        (this.body2 = new ModelRenderer((ModelBase)this, 60, 23)).addBox(-7.0f, 0.0f, -7.0f, 14, 13, 9);
        ...
        (this.head2 = new ModelRenderer((ModelBase)this, 50, 0)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        this.head2.setRotationPoint(0.0f, -1.0f, -6.0f);
        this.head2.setTextureSize(128, 128);
        this.head2.mirror = true;
        this.setRotation(this.head2, 0.0f, 0.0f, 0.0f);
        (this.head3 = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-3.0f, -7.0f, -21.0f, 6, 6, 17);
        ...
        (this.leftarm2 = new ModelRenderer((ModelBase)this, 40, 45)).addBox(-1.0f, -2.0f, -2.0f, 4, 8, 4);
        ...
        (this.rightarm2 = new ModelRenderer((ModelBase)this, 40, 45)).addBox(-3.0f, -2.0f, -2.0f, 4, 8, 4);
        ...
        (this.leftarm3 = new ModelRenderer((ModelBase)this, 40, 60)).addBox(1.0f, 2.0f, 3.0f, 1, 16, 3);
        ...
        (this.rightarm3 = new ModelRenderer((ModelBase)this, 40, 60)).addBox(-2.0f, 2.0f, 3.0f, 1, 16, 3);
