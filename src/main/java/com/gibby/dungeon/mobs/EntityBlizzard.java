...
public class EntityBlizzard extends EntityMob
{
    ...
    public EntityBlizzard(final World par1World) {
        super(par1World);
    ...
    public void onLivingUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (this.func_70845_n()) {
                for (int i = 0; i < 20; ++i) {
                    this.worldObj.spawnParticle("crit", this.posX, this.posY, this.posZ, this.rand.nextGaussian() * 2.0, this.rand.nextGaussian() * 2.0, this.rand.nextGaussian() * 2.0);
                }
            }
        ...
        for (int i = 0; i < 5; ++i) {
            this.worldObj.spawnParticle("blockcrack_" + Block.getIdFromBlock(Blocks.snow) + "_0", this.posX + (this.rand.nextDouble() - 0.5) * this.width, this.posY + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5) * this.width, this.rand.nextGaussian() * 2.0, this.rand.nextGaussian() * 2.0, this.rand.nextGaussian() * 2.0);
            this.worldObj.spawnParticle("blockcrack_" + Block.getIdFromBlock(Blocks.ice) + "_0", this.posX + (this.rand.nextDouble() - 0.5) * this.width, this.posY + this.rand.nextDouble() * this.height, this.posZ + (this.rand.nextDouble() - 0.5) * this.width, this.rand.nextGaussian() * 2.0, this.rand.nextGaussian() * 2.0, this.rand.nextGaussian() * 2.0);
        }
    }
}
