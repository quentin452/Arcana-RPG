...
public class ItemInflameStaff extends ItemForceWand
{
    ...
    public ItemStack onItemRightClick(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3) {
        ...
        if (par4.magicAmount() >= 20 || par3.capabilities.isCreativeMode) {
            par3.addPotionEffect(new PotionEffect(Dungeons.inflame.id, 600, 1));
    ...
    public void addInformation(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final List par3List, final boolean par4) {
        par3List.add(EnumChatFormatting.DARK_PURPLE + "Right Click to gain Inflame, lighting all enemies on fire(20 magic)");
