...
public class ItemNetherSkullSword extends ItemStandardVoidSword
{
    public ItemNetherSkullSword(final Item.ToolMaterial p_i45356_1_, final int i) {
        super(p_i45356_1_, i);
    }
    ...
    public void addInformation(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final List par3List, final boolean par4) {
        ...
        par3List.add(EnumChatFormatting.DARK_BLUE + "Withers on hit");
