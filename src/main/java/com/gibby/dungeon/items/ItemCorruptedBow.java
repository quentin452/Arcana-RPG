...
public class ItemCorruptedBow extends ItemBow
{
    ...
    public void onPlayerStoppedUsing(final ItemStack par1ItemStack, final World par2World, final EntityPlayer par3EntityPlayer, final int par4) {
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Items.arrow)) {
            ...
            final EntityCorruptedArrow entityarrow = new EntityCorruptedArrow(par2World, (EntityLivingBase)par3EntityPlayer, f * 2.0f);
            entityarrow.setDamage(entityarrow.getDamage() + 1.2);
            if (f == 1.0f) {
            ...
            par2World.playSoundAtEntity((Entity)par3EntityPlayer, "random.bow", 1.0f, 1.0f / (ItemCorruptedBow.itemRand.nextFloat() * 0.4f + 1.2f) + f * 0.5f);
            if (flag) {
    ...
    public void registerIcons(final IIconRegister par1IconRegister) {
        ...
        this.iconArray = new IIcon[ItemCorruptedBow.bowPullIconNameArray.length];
