...
public class ItemVampiricSword extends ItemStandardVoidSword
{
    public ItemVampiricSword(final Item.ToolMaterial p_i45356_1_, final int VoidDamage) {
    ...
    public void addInformation(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final List par3List, final boolean par4) {
        par3List.add(EnumChatFormatting.DARK_BLUE + "Drains enemies on hit");
