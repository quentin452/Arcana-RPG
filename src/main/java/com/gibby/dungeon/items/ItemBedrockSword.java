...
public class ItemBedrockSword extends ItemStandardVoidSword
{
    public ItemBedrockSword(final Item.ToolMaterial p_i45356_1_, final int VoidDamage) {
    ...
    public void onUpdate(final ItemStack par1ItemStack, final World par2World, final Entity par3Entity, final int par4, final boolean par5) {
        ...
        if (par3Entity instanceof EntityPlayer) {
            ...
            if (entity.getCurrentEquippedItem() == par1ItemStack) {
                entity.addPotionEffect(new PotionEffect(Potion.resistance.id, 1, 0));
            }
        }
    }
    ...
    public void addInformation(final ItemStack par1ItemStack, final EntityPlayer par2EntityPlayer, final List par3List, final boolean par4) {
        par3List.add(EnumChatFormatting.DARK_PURPLE + "A sturdy sword.");
