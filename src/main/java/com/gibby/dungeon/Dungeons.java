...
@Mod(modid = Dungeons.MODID, version = "1.4.7.7HOTFIX",dependencies = "required-after:reccomplex;")
public class Dungeons
{
    ...
    public static BlockLeaves midnightLeaves;
    ...
    public static BlockLeaves crystalliumLeaves;
    ...
    public static BlockLeaves crystalLeaves;
    ...
    public static BlockLeaves fireflyLeaves;
    ...
    public static BlockLeaves jadeLeaves;
    ...
    public void preinit(final FMLPreInitializationEvent event) {
        ...
        GameRegistry.registerBlock(Dungeons.crystalliumLeaves = (BlockLeaves) new BlockCrystalliumLeaves().setBlockName("crystalliumLeaves").setBlockTextureName(Dungeons.MODID + ":" + "crystalliumleaves").setCreativeTab(Dungeons.Blocks), "dungeons_crystalliumLeaves");
        ...
        GameRegistry.registerBlock(Dungeons.crystalLeaves = (BlockLeaves) new BlockCrystalLeaves().setBlockName("crystalLeaves").setBlockTextureName(Dungeons.MODID + ":" + "crystalleaves").setCreativeTab(Dungeons.Blocks), "dungeons_crystalLeaves");
        ...
        GameRegistry.registerBlock(Dungeons.jadeLeaves = (BlockLeaves) new BlockJadeLeaves().setBlockName("jadeLeaves").setBlockTextureName(Dungeons.MODID + ":" + "jadeLeaves").setCreativeTab(Dungeons.Blocks), "dungeons_jadeLeaves");
        GameRegistry.registerBlock(Dungeons.fireflyLeaves = (BlockLeaves) new BlockFireflyLeaves().setBlockName("fireflyLeaves").setBlockTextureName(Dungeons.MODID + ":" + "fireflyLeaves").setCreativeTab(Dungeons.Blocks), "dungeons_fireflyLeaves");
        GameRegistry.registerBlock(Dungeons.midnightLeaves = (BlockLeaves) new BlockMidnightLeaves().setBlockName("midnightLeaves").setBlockTextureName(Dungeons.MODID + ":" + "midnightLeaves").setCreativeTab(Dungeons.Blocks), "dungeons_midnightLeaves");
