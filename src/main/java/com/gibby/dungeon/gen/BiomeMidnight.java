...
public class BiomeMidnight extends BiomeGenBase
{
    public BiomeMidnight(final int par1) {
    super(par1);
    this.spawnableMonsterList.clear();
    this.spawnableCreatureList.clear();
    this.spawnableWaterCreatureList.clear();
    this.spawnableCaveCreatureList.clear();
    this.setBiomeName("Midight");
    this.topBlock = Dungeons.midnightGrass;
    this.fillerBlock = Dungeons.midnightDirt;
    ...
    Block block = Dungeons.midnightGrass;
    byte b0 = (byte)(this.field_150604_aj & 0xFF);
    Block block2 = Dungeons.midnightDirt;
    int k = -1;
    ...
    for (int l2 = 255; l2 >= 0; --l2) {
        ...
        if (l2 <= p_150560_2_.nextInt(5)) {
            ...
            if (block3 != null && block3.getMaterial() != Material.air) {
                if (block3 == Dungeons.midnightStone) {
                    if (k == -1) {
                        if (l <= 0) {
                            block = null;
                            b0 = 0;
                            block2 = Dungeons.midnightStone;
                        }
                        else if (l2 >= 59 && l2 <= 64) {
                            block = Dungeons.midnightGrass;
                            b0 = (byte)(this.field_150604_aj & 0xFF);
                            block2 = Dungeons.midnightDirt;
                        }
                        ...
                        if (l2 >= 62) {
                            ...
                            block = null;
                            block2 = Dungeons.midnightStone;
                            p_150560_3_[i2] = Dungeons.midnightStone;
                        }
                        else {
                        ...
                        --k;
                        p_150560_3_[i2] = block2;
                        if (k == 0 && block2 == Dungeons.midnightStone) {
