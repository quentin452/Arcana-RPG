        ...
        if (world.getBlock(x, y - 3, z) == Blocks.dirt && world.getBlock(x, y, z) == Blocks.air) {
            ...
            do {
                for (int X2 = 0; X2 < 10; ++X2) {
                    for (int Z2 = 0; Z2 < 10; ++Z2) {
                        world.setBlock(x + X2, y + baseY + 5, z + Z2, Blocks.stonebrick);
                    }
                }
                for (int X2 = 0; X2 < 10; ++X2) {
                    for (int Z2 = 0; Z2 < 10; ++Z2) {
                        world.setBlock(x + X2, y + baseY, z + Z2, Blocks.stonebrick);
                    }
                }
                for (int X2 = -1; X2 < 11; ++X2) {
                    int counter = 0;
                    if (counter % 5 == 0) {
                        world.setBlock(x + X2, y + 11, z - 1, Blocks.stonebrick);
                    }
                    ++counter;
                    for (int Y2 = 0; Y2 < 11; ++Y2) {
                        world.setBlock(x + X2, y + Y2 + baseY, z - 1, Blocks.stonebrick);
                    }
                }
                for (int Y3 = 0; Y3 < 11; ++Y3) {
                    for (int Z2 = -1; Z2 < 11; ++Z2) {
                        world.setBlock(x - 1, y + Y3 + baseY, z + Z2, Blocks.stonebrick);
                        int counter2 = 0;
                        if (counter2 % 5 == 0) {
                            world.setBlock(x - 1, y + 11, z + Z2, Blocks.stonebrick);
                        }
                        ++counter2;
                    }
                }
                for (int X2 = 0; X2 < 10; ++X2) {
                    for (int Z2 = 0; Z2 < 10; ++Z2) {
                        world.setBlock(x + X2, y + 10 + baseY, z + Z2, Blocks.stonebrick);
                    }
                }
                for (int X2 = -1; X2 < 11; ++X2) {
                    int counter = 0;
                    if (counter % 5 == 0) {
                        world.setBlock(x + X2, y + 11, z + 10, Blocks.stonebrick);
                    }
                    ++counter;
                    for (int Y2 = 0; Y2 < 11; ++Y2) {
                        world.setBlock(x + X2, y + Y2 + baseY, z + 10, Blocks.stonebrick);
                    }
                }
                for (int Y3 = 0; Y3 < 11; ++Y3) {
                    for (int Z2 = -1; Z2 < 11; ++Z2) {
                        world.setBlock(x + 10, y + Y3 + baseY, z + Z2, Blocks.stonebrick);
                        int counter2 = 0;
                        if (counter2 % 5 == 0) {
                            world.setBlock(x + 10, y + 11, z + Z2, Blocks.stonebrick);
                        }
                        ++counter2;
                    }
                }
                if (baseY != 0) {
                    stairs(world, x, y + baseY + 11, z, Blocks.stone_brick_stairs, Blocks.stonebrick, 6, 1);
                }
                stairs(world, x + 8, y + baseY + 6, z, Blocks.stone_brick_stairs, Blocks.stonebrick, 6, 1);
                chest(world, rand, x, y + baseY + 6, z + 1, "dungeonChest", rand.nextInt(10) + 1);
                Dungeons.spawnerRepeater(world, x + 6, y + baseY + 6, z + 6, 2, 2, 350);
                if (rand.nextInt(2) == 0) {
                    Dungeons.spawnerRepeater(world, x + 6, y + baseY + 1, z + 6, 18, 2, 350);
                }
                else {
                    Dungeons.spawnerRepeater(world, x + 6, y + baseY + 1, z + 6, 1, 2, 350);
                }
                baseY -= 10;
            ...
            for (int X2 = 0; X2 < 30; ++X2) {
                for (int Z2 = 0; Z2 < 30; ++Z2) {
                    world.setBlock(x + X2, y + baseY + 10, z + Z2 + 11, Blocks.stonebrick);
                }
            }
            for (int X2 = 0; X2 < 30; ++X2) {
                for (int Y = 0; Y < 20; ++Y) {
                    world.setBlock(x + X2, y + Y + baseY + 10, z - 1 + 11, Blocks.stonebrick);
                }
            }
            for (int Y3 = 0; Y3 < 20; ++Y3) {
                for (int Z2 = 0; Z2 < 30; ++Z2) {
                    world.setBlock(x + 30, y + Y3 + baseY + 10, z + Z2 + 11, Blocks.stonebrick);
                }
            }
            for (int X2 = 0; X2 < 30; ++X2) {
                for (int Z2 = 0; Z2 < 30; ++Z2) {
                    world.setBlock(x + X2, y + 20 + baseY + 10, z + Z2 + 11, Blocks.stonebrick);
                }
            }
            for (int X2 = 0; X2 < 30; ++X2) {
                for (int Y = 0; Y < 20; ++Y) {
                    world.setBlock(x + X2, y + Y + baseY + 10, z + 30 + 11, Blocks.stonebrick);
                }
            }
            for (int Y3 = 0; Y3 < 20; ++Y3) {
                for (int Z2 = 0; Z2 < 30; ++Z2) {
                    world.setBlock(x - 1, y + Y3 + baseY + 10, z + Z2 + 11, Blocks.stonebrick);
                }
            }
            for (int X2 = 0; X2 < 4; ++X2) {
                for (int Y = 0; Y < 4; ++Y) {
            ...
            Dungeons.spawner(world, x + 25, y + baseY + 13, z + 25, 19, 1);
            for (int X2 = 0; X2 < 3; ++X2) {
                for (int Z2 = 0; Z2 < 3; ++Z2) {
                    world.setBlock(x + 24 + X2, y + baseY + 11, z + 24 + Z2, Blocks.iron_ore);
                }
            }
            chest(world, rand, x + 25, y + baseY + 12, z + 25, "VoidDungeon", 10);
            return true;
        }
        return false;
    }
