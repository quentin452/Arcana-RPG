...
public class ChunkProviderMidnight implements IChunkProvider
{
    ...
    public ChunkProviderMidnight(final World world, final long seed, final boolean mapFeaturesEnabled) {
        this.stoneNoise = new double[256];
        this.caveGenerator = new MapGenMidnightCaves();
                    ...
                    for (int l3 = 0; l3 < 8; ++l3) {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3) {
                            ...
                            for (int k4 = 0; k4 < 4; ++k4) {
                                if ((d17 += d16) > 0.0) {
                                    blocks[j3 += short1] = Dungeons.midnightStone;
                                }
                                else if (k3 * 8 + l3 < b0) {
                                    blocks[j3 += short1] = Dungeons.midnightStone;
                                }
    ...
    public void replaceBlocksForBiome(final int p_147422_1_, final int p_147422_2_, final Block[] p_147422_3_, final byte[] p_147422_4_, final BiomeGenBase[] p_147422_5_) {
        ...
        for (int k = 0; k < 16; ++k) {
            for (int l = 0; l < 16; ++l) {
                ...
                if (biomegenbase instanceof BiomeMidnight) {
                    ((BiomeMidnight)biomegenbase).genCrystalliumBiomeTerrain(this.rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k, p_147422_2_ * 16 + l, this.stoneNoise[l + k * 16]);
                }
            }
        }
    }
    ...
    public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(10) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        boolean doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        if (this.rand.nextInt(10) == 0) {
            final int k2 = k + this.rand.nextInt(16);
            final int l2 = l + this.rand.nextInt(16);
            final int i2 = this.rand.nextInt(4) + 61;
            new WorldGenMidnightGrassMinable(Dungeons.midnightMossStone, 25).generate(this.worldObj, this.rand, k2, i2, l2);
        }
        ...
        if (this.rand.nextInt(3) == 0) {
            final int k2 = k + this.rand.nextInt(16);
            final int l2 = l + this.rand.nextInt(16);
            final int i2 = this.rand.nextInt(60);
            new WorldGenMidnightMinable(Dungeons.blindlightOre, 8).generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        if (this.rand.nextInt(9) == 0) {
            final int k2 = k + this.rand.nextInt(16);
            final int l2 = l + this.rand.nextInt(16);
            final int i2 = this.rand.nextInt(20);
            new WorldGenMidnightMinable(Dungeons.blindlightOre, 8).generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        for (int m = 0; m < 3; ++m) {
            final int k2 = k + this.rand.nextInt(16);
            final int l2 = l + this.rand.nextInt(16);
            final int i2 = this.rand.nextInt(80);
            new WorldGenMidnightMinable(Dungeons.runicOre, 8).generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        for (int m = 0; m < 4; ++m) {
            final int k2 = k + this.rand.nextInt(16);
            final int l2 = l + this.rand.nextInt(16);
            final int i2 = this.rand.nextInt(80);
            new WorldGenMidnightMinable(Dungeons.fireflyStone, 4).generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        for (int m = 0; m < 4; ++m) {
            final int k2 = k + this.rand.nextInt(16);
            final int l2 = l + this.rand.nextInt(16);
            final int i2 = this.rand.nextInt(80);
            new WorldGenMidnightMinable(Dungeons.blackIronOre, 8).generate(this.worldObj, this.rand, k2, i2, l2);
        }
        int k2;
        int l2;
        int i2;
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM), i1 = 0L; doGen && i1 < 45L; ++i1) {
            k2 = k + this.rand.nextInt(16);
            l2 = l + this.rand.nextInt(16);
            i2 = this.rand.nextInt(50) + 60;
            new WorldGenMidnightFoliage().generate(this.worldObj, this.rand, k2, i2, l2);
        }
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM), i1 = 0L; doGen && i1 < 80L; ++i1) {
            k2 = k + this.rand.nextInt(16);
            l2 = l + this.rand.nextInt(16);
            i2 = this.rand.nextInt(50) + 10;
            new WorldGenGlowingBrambles().generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        if (this.rand.nextInt(150) == 0) {
            ...
            l2 = l + this.rand.nextInt(16);
            i2 = 63;
            new WorldGenShadowBlock().generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
        if (this.rand.nextInt(250) == 0) {
            ...
            l2 = l + this.rand.nextInt(16);
            i2 = 63;
            new WorldGenShadowAltar().generate(this.worldObj, this.rand, k2, i2, l2);
        }
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM), i1 = 0L; doGen && i1 < 2L; ++i1) {
            k2 = k + this.rand.nextInt(16);
            l2 = l + this.rand.nextInt(16);
            i2 = this.rand.nextInt(15) + 64;
            new WorldGenMidnightTrees().generate(this.worldObj, this.rand, k2, i2, l2);
        }
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM), i1 = 0L; doGen && i1 < 5L; ++i1) {
            k2 = k + this.rand.nextInt(16);
            l2 = l + this.rand.nextInt(16);
            i2 = this.rand.nextInt(35) + 75;
            new WorldGenFireflyTrees().generate(this.worldObj, this.rand, k2, i2, l2);
        }
        doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM);
    ...
    public List getPossibleCreatures(final EnumCreatureType par1EnumCreatureType, final int par2, final int par3, final int par4) {
        return Dungeons.midnightBiome.getSpawnableList(par1EnumCreatureType);
    }
