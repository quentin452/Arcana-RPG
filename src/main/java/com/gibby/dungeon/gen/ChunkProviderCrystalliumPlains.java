...
public class ChunkProviderCrystalliumPlains implements IChunkProvider
{
    ...
    public void populate(final IChunkProvider par1IChunkProvider, final int par2, final int par3) {
        ...
        if (biomegenbase != BiomeGenBase.desert && biomegenbase != BiomeGenBase.desertHills && !flag && this.rand.nextInt(6) == 0 && TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, flag, PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        for (doGen = TerrainGen.populate(par1IChunkProvider, this.worldObj, this.rand, par2, par3, false, PopulateChunkEvent.Populate.EventType.CUSTOM), i1 = 0L; doGen && i1 < 4L; ++i1) {
            ...
            l2 = l + this.rand.nextInt(16);
            i2 = this.rand.nextInt(60);
            new WorldGenCrystalMinable(Dungeons.magirockOre, 8).generate(this.worldObj, this.rand, k2, i2, l2);
        }
