...
public class WorldGenSmallCrystalTree extends WorldGenerator implements IWorldGenerator
{
    ...
    public boolean generate(final World world, final Random rand, final int i, final int j, final int k) {
        if (world.getBlock(i + 3, j - 1, k + 3) != Dungeons.crystalliumGrass && world.getBlock(i + 3, j - 1, k + 3) != Dungeons.crystalWood) {
            return false;
        }
        for (int c = 0; c < 10; ++c) {
