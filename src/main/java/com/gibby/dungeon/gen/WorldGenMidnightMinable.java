...
public class WorldGenMidnightMinable extends WorldGenerator
{
    ...
    public WorldGenMidnightMinable(final Block p_i45459_1_, final int p_i45459_2_) {
        this(p_i45459_1_, p_i45459_2_, Dungeons.midnightStone);
    }

    public WorldGenMidnightMinable(final Block p_i45460_1_, final int p_i45460_2_, final Block p_i45460_3_) {
        this.field_150519_a = p_i45460_1_;
        this.numberOfBlocks = p_i45460_2_;
        this.field_150518_c = p_i45460_3_;
    }

    public WorldGenMidnightMinable(final Block block, final int meta, final int number, final Block target) {
