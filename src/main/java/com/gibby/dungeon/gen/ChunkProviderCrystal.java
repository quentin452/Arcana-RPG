        ...
        for (int k = 0; k < 16; ++k) {
            for (int l = 0; l < 16; ++l) {
                ...
                if (biomegenbase instanceof BiomeCrystal) {
                    ((BiomeCrystal)biomegenbase).genCrystalliumBiomeTerrain(this.worldObj, this.rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k, p_147422_2_ * 16 + l, this.stoneNoise[l + k * 16]);
                }
            }
        }
    }
