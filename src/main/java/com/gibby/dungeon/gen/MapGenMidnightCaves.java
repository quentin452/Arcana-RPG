...
public class MapGenMidnightCaves extends MapGenBase
{
    ...
    protected void func_151541_a(final long p_151541_1_, final int p_151541_3_, final int p_151541_4_, final Block[] p_151541_5_, double p_151541_6_, double p_151541_8_, double p_151541_10_, final float p_151541_12_, float p_151541_13_, float p_151541_14_, int p_151541_15_, int p_151541_16_, final double p_151541_17_) {
        ...
        while (p_151541_15_ < p_151541_16_) {
            ...
            if (!flag2 && p_151541_15_ == k1 && p_151541_12_ > 1.0f && p_151541_16_ > 0) {
                this.func_151541_a(random.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, random.nextFloat() * 1.5f + 1.5f, p_151541_13_ - 1.5707964f, p_151541_14_ / 3.0f, p_151541_15_, p_151541_16_, 1.0);
                this.func_151541_a(random.nextLong(), p_151541_3_, p_151541_4_, p_151541_5_, p_151541_6_, p_151541_8_, p_151541_10_, random.nextFloat() * 1.5f + 1.5f, p_151541_13_ + 1.5707964f, p_151541_14_ / 3.0f, p_151541_15_, p_151541_16_, 1.0);
                return;
            }
    ...
    protected void func_151538_a(final World p_151538_1_, final int p_151538_2_, final int p_151538_3_, final int p_151538_4_, final int p_151538_5_, final Block[] p_151538_6_) {
        ...
        for (int j1 = 0; j1 < i1; ++j1) {
            ...
            if (this.rand.nextInt(4) == 0) {
                this.func_151542_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d2, d3);
            ...
            for (int l1 = 0; l1 < k1; ++l1) {
                ...
                this.func_151541_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d2, d3, f3, f, f2, 0, 0, 1.0);
            }
        }
    }
    ...
    private boolean isTopBlock(final Block[] data, final int index, final int x, final int y, final int z, final int chunkX, final int chunkZ) {
        ...
        if (this.isExceptionBiome(biome)) {
            if (data[index] == Dungeons.midnightGrass) {
                return true;
            }
        }
        else if (data[index] == Dungeons.midnightGrass) {
            return true;
        }
        if (this.isExceptionBiome(biome) ? (data[index] != Dungeons.midnightGrass) : (data[index] != Dungeons.midnightGrass)) {
            return false;
        }
        return true;
    }
    ...
    protected void digBlock(final Block[] data, final int index, final int x, final int y, final int z, final int chunkX, final int chunkZ, final boolean foundTop) {
        final BiomeGenBase biome = this.worldObj.getBiomeGenForCoords(x + chunkX * 16, z + chunkZ * 16);
        final Block top = this.isExceptionBiome(biome) ? Dungeons.midnightGrass : Dungeons.midnightGrass;
        final Block filler = this.isExceptionBiome(biome) ? Dungeons.midnightDirt : Dungeons.midnightDirt;
        final Block block = data[index];
        if (block == Dungeons.midnightStone || block == filler || block == top) {
            if (y < 10) {
